...
```bash
claude mcp add --scope user glm -- npx -y @nocompromiseai/glm-mcp@0.7.0
```

**Codex**

```bash
codex mcp add glm -- npx -y @nocompromiseai/glm-mcp@0.7.0
```

**Antigravity**

```bash
agy mcp add glm -- npx -y @nocompromiseai/glm-mcp@0.7.0
```
...
```bash
agy mcp add -e GLM_MCP_ROOTS=/abs/path/one:/abs/path/two glm -- npx -y @nocompromiseai/glm-mcp@0.7.0
```
