...
// the write truncates any result big enough to not fit the pipe buffer — which
// looks exactly like a malformed result rather than a lost one. Exit from the
// write's own callback instead.
